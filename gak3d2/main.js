...
// Lights
const pointLight = new THREE.PointLight(0xffffff); //Creates the primary light
...
const smileMaterial = new THREE.MeshBasicMaterial({map: smileTexture}) //Defines the material of the sphere
